...
public class TestSearchAndAppendInterceptor {

  private static final Logger logger =
      LoggerFactory.getLogger(TestSearchAndAppendInterceptor.class);
  ...
  private void testSearchReplace(Context context, String input, String output)
    ...
    //Interceptor.Builder builder = InterceptorBuilderFactory.newInstance(
      //      org.apache.flume.interceptor.SearchAndAppendInterceptor.Builder.class.toString());
    Interceptor.Builder builder = new SearchAndAppendInterceptor.Builder();
